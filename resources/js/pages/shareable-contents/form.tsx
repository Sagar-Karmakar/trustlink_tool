...
export default function ShareableContentForm({
    contentItem,
    isEdit,
    category_name,
}: FormProps) {
        ...
        if (val.trim().length >= 3) {
            try {
                const response = await fetch(
                    `/shareable-contents/categories/search?query=${encodeURIComponent(val)}`,
                );
            ...
            <div className="relative z-10 mx-auto max-w-5xl space-y-6">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <div className="flex items-center gap-2">
                                <Megaphone className="h-4 w-4 shrink-0 text-blue-600 sm:h-5 sm:w-5 dark:text-blue-400" />
                                <h1 className="text-base font-bold tracking-tight text-slate-900 sm:text-xl dark:text-zinc-100">
                                    {isEdit
                                        ? 'Edit Quick Share Content'
                                        : 'Create New Quick Share'}
                                </h1>
                            </div>
                            <p className="mt-0.5 text-xs text-slate-500 dark:text-zinc-400">
                                Define the title, upload the primary post image,
                                and format the message text.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="space-y-6 md:col-span-1">
                        <div className="space-y-5 rounded-2xl border border-white/20 bg-white/45 p-4 shadow-lg backdrop-blur-xl sm:p-6 dark:border-zinc-800/40 dark:bg-zinc-950/45">
                            ...
                            <div className="space-y-2">
                                ...
                                <Input
                                    ...
                                    className="rounded-xl border border-zinc-200/50 bg-white/30 focus-visible:ring-sky-500/50 dark:border-zinc-800/60 dark:bg-zinc-900/30"
                                    required
                                />
                            ...
                            <div className="relative space-y-2">
                                ...
                                <Input
                                    ...
                                    onFocus={() =>
                                        data.category_name.trim().length >= 3 &&
                            ...
                            <div className="space-y-2">
                                ...
                                <div
                                    ...
                                    className="dark:border-zinc-850 flex min-h-[160px] cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-zinc-200 bg-zinc-500/5 p-4 transition-all duration-300 hover:border-blue-500 hover:bg-zinc-500/10 dark:hover:border-blue-400"
                                >
                                    {imagePreview ? (
                                        ...
                                        <div className="space-y-2 text-center">
                                            <div className="inline-block rounded-full bg-zinc-200/40 p-3 text-zinc-400 dark:bg-zinc-900/40">
...
throw new Error(
                            ...
                            {/* Action Buttons */}
                            <div className="flex items-center justify-end gap-3 border-t border-zinc-200/50 pt-3 dark:border-zinc-800/40">
                                <Link href="/contents">
                                    <Button
                                        type="button"
                                        variant="ghost"
                                        className="rounded-xl border border-zinc-200 px-5 hover:bg-zinc-100 dark:border-zinc-800 dark:hover:bg-zinc-900"
                                    >
                                        Cancel
                                    </Button>
                                </Link>
                                <Button
                                    type="submit"
                                    disabled={processing}
                                    className="transform gap-2 rounded-xl border-0 bg-gradient-to-r from-blue-600 to-sky-500 px-6 font-semibold text-white shadow-lg shadow-blue-500/25 transition-all duration-300 hover:from-blue-500 hover:to-sky-400 hover:shadow-blue-500/40 active:scale-95"
                                >
