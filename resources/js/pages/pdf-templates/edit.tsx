...
export default function EditTemplate({ template, category_name }: Props) {
    ...
    const [categoryName, setCategoryName] = useState(category_name || 'uncategory');
    const [content, setContent] = useState(template.content);
    const [variables, setVariables] = useState<Record<string, VariableConfig>>(template.variables || {});
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.put(`/pdf-templates/${template.id}`, {
            name,
            content,
            variables,
